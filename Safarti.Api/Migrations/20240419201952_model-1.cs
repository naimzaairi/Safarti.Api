        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nationality = table.Column<string>(type: "varchar(3)", maxLength: 3, nullable: false),
                    IdNumber = table.Column<string>(type: "varchar(25)", maxLength: 25, nullable: false),
                    ...
                    OrganizedTravels = table.Column<int>(type: "int", nullable: false),
                    ParticipatedTravels = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileRankings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileRankings_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeetingPlace = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    Places = table.Column<int>(type: "int", nullable: false),
                    OtherInformation = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Travels_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileRankings_ProfileId",
                table: "ProfileRankings",
                column: "ProfileId");
